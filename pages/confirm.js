...
const Confirm = () => {
    ...
    const [pickupCoordinates, setPickupCoordinates] = useState(0)
    const [dropoffCoordinates, setDropoffCoordinates] = useState(0)
    // 
...
const ButtonContainer = tw.div`
    bg-white absolute z-10 m-2 cursor-pointer rounded-full
`
